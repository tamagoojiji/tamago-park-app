...
const SHOW_IMAGES: Record<string, string> = {
  ...
  'ヒッポグリフ': '/images/shows/ヒッポグリフ・マジカル・レッスン.png',
  'フロッグ・クワイア': '/images/shows/フロッグ・クワイア.png',
  'ホグズミード': '/images/shows/ホグズミード・マジカル・クリーチャーズ・ミート.png',
  'クロミ': '/images/shows/クロミ・ライブ〜Discover Me Discover U!!!〜.png',
